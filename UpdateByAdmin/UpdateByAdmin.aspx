<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateByAdmin.aspx.cs" Inherits="ErelsProject.UpdateByAdmin" %>
        ...
        <div dir="rtl">
           ...
           <center>
            ...
            <asp:Button ID="Button4" runat="server" Text="עדכן" OnClick="Button1_Click4" />
               <br /><br /><br />
               <asp:Button Text="לחץ לחזור לעמוד האדמין" runat="server" OnClick="ButtonHome" />
           </center>
        </div>
    </form>
</body>
